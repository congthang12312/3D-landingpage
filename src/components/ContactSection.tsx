...
const FloatingShape = () => {
  ...
  return (
    <Float speed={2} rotationIntensity={1}>
      <Icosahedron ref={meshRef} args={[1.5]} scale={1.5}>
        <MeshDistortMaterial
          color="#0ea5e9"
          distort={0.3}
          speed={2}
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Hãy <span className="gradient-text">kết nối</span> với TechVN
            </h2>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Bạn có dự án cần thực hiện? Hãy liên hệ với chúng tôi để được tư vấn miễn phí.
              Đội ngũ TechVN luôn sẵn sàng lắng nghe và hỗ trợ bạn.
            </p>
